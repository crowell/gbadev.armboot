...
int powerpc_load_dol(const char *path, u32 *endAddress)
{
        ...
        if (endAddress)
                *endAddress = end - 1;
		gecko_printf("endAddress = %08x", *endAddress);
        return 0;
}
...
int powerpc_boot_file(const char *path)
{
		...
		gecko_printf("powerpc_load_dol returned %d .", fres);
        sensorbarOff();
        udelay(300000);
		...
		write32(0x100, 0x38600005); //li   r3,5
		write32(0x104, 0x7c6903a6); //mtctr  r3
		write32(0x108, 0x3c600d00); //lis r3,3328
		write32(0x10c, 0x808300c0); //lwz r4,192(r3)
		write32(0x110, 0x3ca000ff); //lis r5,255
		write32(0x114, 0x60a5feff); //ori r5,r5,65279
		write32(0x118, 0x7c842838); //and r4,r4,r5
		write32(0x11c, 0x908300c0); //stw r4,192(r3)
		write32(0x120, 0x7c6c42e6); //mftbl  r3
		write32(0x124, 0x3ca001c9); //lis r5,457
		write32(0x128, 0x60a5c380); //ori r5,r5,50048
		write32(0x12c, 0x7c8c42e6); //mftbl  r4
		write32(0x130, 0x7c832050); //subf r4,r3,r4
		write32(0x134, 0x7c042840); //cmplw  r4,r5
		write32(0x138, 0x4180fff4); //blt+ 0x12c ?
		write32(0x13c, 0x3c600d00); //lis r3,3328
		write32(0x140, 0x808300c0); //lwz r4,192(r3)
		write32(0x144, 0x60840100); //ori r4,r4,256
		write32(0x148, 0x908300c0); //stw r4,192(r3)
		write32(0x14c, 0x7c6c42e6); //mftbl  r3
		write32(0x150, 0x3ca001c9); //lis r5,457
		write32(0x154, 0x60a5c380); //ori r5,r5,50048
		write32(0x158, 0x7c8c42e6); //mftbl  r4
		write32(0x15c, 0x7c832050); //subf r4,r3,r4
		write32(0x160, 0x7c042840); //cmplw  r4,r5
		write32(0x164, 0x4200ff98); //blt+ 0x158 ?
		write32(0x168, 0x4200ff98); //bdnz+  0x100 ?
        write32(0x16c, makeAbsoluteBranch(0x170, false));
        write32(0x170, makeAbsoluteBranch(0x16c, false));
		...
		makeAbsoluteBranch(0x100, false);
